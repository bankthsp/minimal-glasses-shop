...
// Updates:
// - Add social links (Facebook / TikTok / Instagram) + Google Maps
...
// - NEW:
//   1) Service card: auto-sliding images (CSS-only, safe for Server Components)
//   2) Expert card: doctor photo + certificates (images)
//   3) Social buttons: add platform icons
...
function ExternalButton({
  ...
  const rightCls =
    "text-xs font-semibold " + (tone === "dark" ? "text-white/70" : "text-slate-500");
...
function ServiceAutoSlider({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-orange-200/35 bg-white/70">
      <style
        // scoped animation
      ...
      <div className="relative aspect-[16/10]">
        ...
        {/* overlay */}
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_20%_10%,rgba(249,115,22,0.18),transparent_60%)]" />
      </div>
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-700">
                  (Mock) เพิ่มรูปประกอบและสไลด์อัตโนมัติเพื่อให้กล่องมีชีวิตขึ้น
                </p>
              </div>
              ...
              <div className="sm:col-span-3">
                <div className="grid grid-cols-1 gap-3">
                  {[
                    ...
                    <div
                      key={v.title}
                      className="rounded-2xl border border-orange-200/35 bg-white/75 p-4"
                    >
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <h3 className="mt-2 text-xl font-semibold tracking-tight text-white">
                  นัดตรวจสายตาหรือปรึกษาการเลือกเลนส์
                </h3>
